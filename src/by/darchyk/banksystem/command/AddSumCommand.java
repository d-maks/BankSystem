...
public class AddSumCommand implements ActionCommand {
	...
	public String execute(HttpServletRequest request) {
		...
		if(isAuditorSum(request.getParameter(SUM))){
			...
			return page = ConfigurationManager.getProperty("path.page.plus_deposit");
		}
		...
		String action = dataTime+" на счет добавлено "+Integer.parseInt(request.getParameter(SUM));
